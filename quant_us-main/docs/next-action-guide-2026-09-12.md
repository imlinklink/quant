...
> 2026-09-13 新策略入口：美股 3–6 个月 ETF 双动量、科技股截面动量和中期趋势择时的冻结、开发、回测与验收步骤，见 [美股 3–6 个月动量基准实验交接手册](us-medium-term-momentum-baseline-handoff-manual-2026-09-13.md)。该实验不含 LLM，不改变在线 shadow/交易权限；完成规则基准后才评估 LLM 增量。

> 2026-09-13 最新系统全图：在线运行、LLM、确认台、订单和历史实验的关系，见 [系统架构全图](system-architecture-map-2026-09-13.md)。后续15只股票测试的执行顺序、当前阻断、逐日留痕和验收标准，见 [15只前向测试交接手册](survivor15-forward-test-handoff-manual-2026-09-13.md)。
