    ...
    def test_listing_delisting_and_liquidity_are_point_in_time(self):
        master=pd.DataFrame([{'code':'US.A','listing_date':'2020-01-02','delisting_date':'',
                             ...
                             {'code':'US.B','listing_date':'2020-01-03','delisting_date':'2020-01-03',
                              'asset_type':'stock'}])
        liquidity=pd.DataFrame([{'date':'2020-01-02','code':'US.A','close':10,'dollar_volume':6e6},
                                {'date':'2020-01-03','code':'US.A','close':4,'dollar_volume':6e6},
                                {'date':'2020-01-03','code':'US.B','close':10,'dollar_volume':6e6}])
