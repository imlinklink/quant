...
随后按 v3 的15只重跑，setup 截止提前至2026-06-30以覆盖完整40交易日质量窗口。初版虽有4,001个 setup，却误用旧 QFQ 股票池筛选入场，7,889条入场和347,116个矩阵单元只保留为缺陷追溯。使用原始价重建 T−1 流动性及股票池后，复核为8,048条 A/B/C 入场、354,112个矩阵单元；相同范围下新旧 setup 4,001/4,001完全配对。详见 [原始价股票池复核](m2-raw-asof-raw-universe-audit-2026-09-12.md)；尚未冻结正式 Manifest，不能发布收益结论。
