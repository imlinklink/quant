...
> 2026-09-12 更新：公司行动退出会计和质量门已完成，v3 放行的15只已通过第二轮工程重跑，见 [15只重跑记录](m2-raw-asof-15-stock-rerun-2026-09-12.md)。当前下一步是提交干净代码并创建新的正式 ABC Manifest；ORCL/QCOM/TSM/UNH 在行动历史补齐前继续排除。
